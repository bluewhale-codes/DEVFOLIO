...
const Test2 = () => {
  ...
  return (
    <section ref={sectionRef} className="w-full min-h-screen bg-[#f0eeea] relative overflow-hidden">
      {/* Grain texture */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 relative">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
          ...
          <div ref={centerRef} className="lg:col-span-4 relative flex items-center justify-center min-h-[350px] sm:min-h-[450px] lg:min-h-[500px]">
             <Test width='400px' height='400px'/>
          </div>

          {/* RIGHT SIDE - Code Cards & Tech Stack */}
          <div ref={rightRef} className="lg:col-span-4 flex flex-col gap-4 sm:gap-6">
            {/* Code Snippets */}
