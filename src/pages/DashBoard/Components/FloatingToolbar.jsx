...
export default function FloatingToolbar({toggle}) {
  ...
  return (
    <div className="fixed  z-50 bg-[#1f1f1f] rounded-2xl shadow-2xl px-4 py-3 flex items-center gap-3">
      ...
      <button onClick={toggle} className="flex items-center gap-2 px-3 py-2 bg-zinc-800 hover:bg-zinc-700 rounded-lg transition-colors">
